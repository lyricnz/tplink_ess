...
from custom_components.tplink_ess import async_setup_entry
from custom_components.tplink_ess.const import DEFAULT_NAME, DOMAIN, SWITCH
...
async def test_switch_services(hass):
    ...
    with patch(
        "custom_components.tplink_ess.TPLinkESSClient.async_set_title"
    ) as title_func:
